export interface CustomerConfig {
  ...
  hero: {
    ...
    description: string
    image: string
    cta: { label: string; scrollTo?: string }
...
export type Section =
  ...
  | { type: 'benefits'; title: string; items: string[]; description?: string; image?: string; imagePosition?: 'left' | 'right' }
  | { type: 'steps'; title: string; steps: { title: string; description: string }[] }
  | { type: 'pricing'; title: string; layout?: 'grid' | 'list'; items: { label: string; price: string; note?: string }[] }
  | { type: 'testimonials'; title: string; items: { quote: string; author: string }[] }
  | { type: 'location'; title: string; mapQuery?: string }
  | { type: 'cta'; title: string; description: string; buttonLabel: string; scrollTo?: string }
