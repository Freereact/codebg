    ...
    <div className="mx-auto max-w-4xl space-y-10">
      <div className="section-card p-8 md:p-10">
        ...
        <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-700 dark:text-slate-300">
          Agile, transparent, and affordable. AI powered by human expertise moves every phase faster — and we pass that
          speed directly to your timeline and cost.
        </p>
      </div>
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2 stagger-children">
          <Card as="article">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              Scaffolding, responsive variants, copy drafts — AI handles the bulk, and our expert polishes the result.
              You only pay for the thinking, not the typing.
            </p>
          </Card>
          <Card as="article">
            <h3 className="font-semibold text-slate-800 dark:text-slate-100">Fewer revision rounds</h3>
            <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              Clear intake, wireframe approval, and fast iteration mean we get it right quickly. Less back-and-forth =
          ...
          <Card as="article">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              Push, test, deploy — our CI pipeline eliminates manual deployment steps and the human errors that come
              with them.
            </p>
          </Card>
          <Card as="article">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              You know exactly what you&apos;re getting before we start building. No surprise invoices, no scope creep.
            </p>
          </Card>
        </div>
      </div>
      ...
      <div className="section-card bg-gradient-to-br from-accent-soft to-amber-50 dark:from-orange-950/40 dark:to-amber-950/30 p-8 md:p-10 text-center">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-50">Let&apos;s start with Step 1</h2>
