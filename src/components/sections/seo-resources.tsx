  ...
  return (
    ...
    >
      <div className="mt-5 grid gap-4 sm:grid-cols-2">
        <Card as="a" href="/services/web-design-penticton.html" variant="link" className="rounded-xl">
        ...
        <Card as="a" href="/services/website-redesign.html" variant="link" className="rounded-xl">
